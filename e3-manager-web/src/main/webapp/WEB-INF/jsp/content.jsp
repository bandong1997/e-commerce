        ...
        <div data-options="region:'center'" style="padding:5px">
		    ...
		    <thead>
		        <tr>
		            ...
		            <th data-options="field:'url',width:75,align:'center',formatter:E3.formatUrl">内容连接</th>
		            <th data-options="field:'pic',width:70,align:'center',formatter:E3.formatUrl">图片</th>
		            <th data-options="field:'pic2',width:65,align:'center',formatter:E3.formatUrl">图片2</th>
		            <th data-options="field:'created',width:150,align:'center',formatter:E3.formatDateTime">创建日期</th>
		            <th data-options="field:'updated',width:150,align:'center',formatter:E3.formatDateTime">更新日期</th>
		        </tr>
		    </thead>
		</table>
        </div>
